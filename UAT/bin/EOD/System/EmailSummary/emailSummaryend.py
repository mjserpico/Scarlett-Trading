...
logging.basicConfig(filename='EmailSummaryEND' + str(datetime.date.today()) + '.txt', level=logging.DEBUG, format='%(asctime)s - %(levelname)s - %(message)s')
...
messagetext = "PROD Account Balance is  \n" + str(Balance[0])
subjecttext = "PROD Account Summary"
