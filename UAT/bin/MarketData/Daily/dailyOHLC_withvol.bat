...
ECHO Starting A OHLC %date% %time% >> "%LOGFILE%"
call "%Python%Python.exe" "%~dp0AdailyOHLC_withvol.py"
ECHO Ending A OHLC %date% %time% >> "%LOGFILE%"
ECHO Starting DRIP OHLC %date% %time% >> "%LOGFILE%"
...
ECHO Starting DRIP OHLC %date% %time% >> "%LOGFILE%"
call "%Python%Python.exe" "%~dp0AETdailyOHLC_withvol.py"
ECHO Ending DRIP OHLC %date% %time% >> "%LOGFILE%"
ECHO Starting DRIP OHLC %date% %time% >> "%LOGFILE%"
...
ECHO Ending DRIP OHLC %date% %time% >> "%LOGFILE%"
ECHO Starting DRIP OHLC %date% %time% >> "%LOGFILE%"
call "%Python%Python.exe" "%~dp0ANDVdailyOHLC_withvol.py"
ECHO Ending DRIP OHLC %date% %time% >> "%LOGFILE%"
ECHO Starting DRIP OHLC %date% %time% >> "%LOGFILE%"
...
ECHO Ending DRIP OHLC %date% %time% >> "%LOGFILE%"
ECHO Starting DRIP OHLC %date% %time% >> "%LOGFILE%"
call "%Python%Python.exe" "%~dp0APHTdailyOHLC_withvol.py"
ECHO Ending DRIP OHLC %date% %time% >> "%LOGFILE%"
ECHO Starting DRIP OHLC %date% %time% >> "%LOGFILE%"
...
ECHO Ending DRIP OHLC %date% %time% >> "%LOGFILE%"
ECHO Starting DRIP OHLC %date% %time% >> "%LOGFILE%"
call "%Python%Python.exe" "%~dp0CAdailyOHLC_withvol.py"
ECHO Ending DRIP OHLC %date% %time% >> "%LOGFILE%"
ECHO Starting DRIP OHLC %date% %time% >> "%LOGFILE%"
...
ECHO Ending DRIP OHLC %date% %time% >> "%LOGFILE%"
ECHO Starting DRIP OHLC %date% %time% >> "%LOGFILE%"
call "%Python%Python.exe" "%~dp0CSRAdailyOHLC_withvol.py"
ECHO Ending DRIP OHLC %date% %time% >> "%LOGFILE%"
ECHO Starting DRIP OHLC %date% %time% >> "%LOGFILE%"
...
ECHO Ending DRIP OHLC %date% %time% >> "%LOGFILE%"
ECHO Starting DRIP OHLC %date% %time% >> "%LOGFILE%"
call "%Python%Python.exe" "%~dp0DISCAdailyOHLC_withvol.py"
ECHO Ending DRIP OHLC %date% %time% >> "%LOGFILE%"
ECHO Starting DRIP OHLC %date% %time% >> "%LOGFILE%"
call "%Python%Python.exe" "%~dp0DISCKdailyOHLC_withvol.py"
ECHO Ending DRIP OHLC %date% %time% >> "%LOGFILE%"
ECHO Starting DRIP OHLC %date% %time% >> "%LOGFILE%"
...
ECHO Ending DRIP OHLC %date% %time% >> "%LOGFILE%"
ECHO Starting DRIP OHLC %date% %time% >> "%LOGFILE%"
call "%Python%Python.exe" "%~dp0COLdailyOHLC_withvol.py"
ECHO Ending DRIP OHLC %date% %time% >> "%LOGFILE%"
ECHO Starting DRIP OHLC %date% %time% >> "%LOGFILE%"
...
ECHO Ending DRIP OHLC %date% %time% >> "%LOGFILE%"
ECHO Starting DRIP OHLC %date% %time% >> "%LOGFILE%"
call "%Python%Python.exe" "%~dp0ESRXdailyOHLC_withvol.py"
ECHO Ending DRIP OHLC %date% %time% >> "%LOGFILE%"
ECHO Starting DRIP OHLC %date% %time% >> "%LOGFILE%"
