...
call "C:\Program Files\Serpico\autotasks\DailyOHLC.bat"
...
call "C:\Program Files\Serpico\autotasks\DailyOHLC6E.bat"
ECHO Ran OHLC script %date% %time%>> "%LOGFILE%"
timeout /t 1

call "C:\Program Files\Serpico\autotasks\AccountBalance.bat"
ECHO Ran Account Balance %date% %time%>> "%LOGFILE%"
timeout /t 1


call "C:\Program Files\Serpico\autotasks\emailSummary.bat"
ECHO Email Summary email sent %date% %time%>> "%LOGFILE%"
timeout /t 1