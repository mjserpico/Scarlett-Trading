...
logging.basicConfig(filename='pythonlogs\BasisDailyOHLC' + str(datetime.date.today()) + '.txt', level=logging.DEBUG, format='%(asctime)s - %(levelname)s - %(message)s')
logger = logging.getLogger()
logger.setLevel(logging.DEBUG)

formatter = logging.Formatter('%(asctime)s - %(levelname)s - %(message)s')

fh = logging.FileHandler('ZDailyOHLC' + str(datetime.date.today()) + '.txt')
...
logger.debug('Starting ZDailyOHLC')
...
#    
logger.debug('Finished Z Daily OHLC')
conn.disconnect()