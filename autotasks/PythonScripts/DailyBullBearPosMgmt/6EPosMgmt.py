...
logging.basicConfig(filename='pythonlogs\DailyPosMgmt6E' + str(datetime.date.today()) + '.txt', level=logging.DEBUG, format='%(asctime)s - %(levelname)s - %(message)s')
logger = logging.getLogger()
logger.setLevel(logging.DEBUG)

formatter = logging.Formatter('%(asctime)s - %(levelname)s - %(message)s')

fh = logging.FileHandler('DailyPosMgmt6E' + str(datetime.date.today()) + '.txt')
...
#Sets the Master Fill and Cancels other LE orders
    ...
    logger.error('Canceled Order %s', Order_entryES[0] )
