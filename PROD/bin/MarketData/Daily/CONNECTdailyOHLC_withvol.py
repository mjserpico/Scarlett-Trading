...
#            query = ("UPDATE "+ Table +" SET 30Dvol = " + str(thirtyd) + " where ID =\'" + str(ID1[0]) +"\';")
#            logger.debug('Query is %s', query)
#            print(query)
#            cur.execute(query)
#            cnx.commit()
...
#            query = ("UPDATE "+ Table +" SET 60Dvol = " + str(sixtyd) + " where ID =\'" + str(ID1[0]) +"\';")
#            logger.debug('Query is %s', query)
#            print(query)
#            cur.execute(query)
#            cnx.commit()
...
#            query = ("UPDATE "+ Table +" SET 90Dvol = " + str(ninetyd) + " where ID =\'" + str(ID1[0]) +"\';")
#            logger.debug('Query is %s', query)
#            print(query)
#            cur.execute(query)
#            cnx.commit()
